...
$string['attemptnotclosed'] = 'Attempt has not closed yet';
...
$string['choosecondtiontypetoadd'] = 'Choose a condtion type';
...
$string['editingfeedbackx'] = 'Editing feedback: {$a}';
...
$string['feedbackquestion'] = 'Using placeholders for question feedback';
...
$string['grademethod_oneattempt'] = 'Only one attempt is allowed';
$string['grademethod_bestattempt'] = 'The best attempt is used for grading';
$string['grademethod_lastattempt'] = 'The last attempt is used for grading';
